...
Vagrant.configure("2") do |config|
  ...
  # OTGSfile
  #
  # File with custom configuration that can be generated by otgs scripts - not to be modified manually, as it
  # could be overwritten. See Customfile for details.
  #if File.exists?(File.join(vagrant_dir,'OTGSfile')) then
  #  eval(IO.read(File.join(vagrant_dir,'OTGSfile')), binding)
  #end
